...
[TestClass]
public class Day2RedNosedReportsTests
{
    ...
    public static IEnumerable<object[]> CalculateNbSafeReports_SimpleCases_PerformsCorrectly_data()
    {
    ...
    [TestMethod]
    public void CalculateNbSafeReports_Sample_PerformsCorrectly()
    {
        // Arrange
        Day2RedNosedReports day2RedNosedReports = new();
    ...
    [TestMethod]
    public void CalculateNbSafeReports_Test_PerformsCorrectly()
    {
        // Arrange
        Day2RedNosedReports day2RedNosedReports = new();
        List<List<int>> reports =
