...
[TestClass]
public class Day3MullItOverTests
{
    ...
    [TestMethod]
    [DataRow("mul(3,7)", 21)]
    [DataRow("mul(3,7)mul(5,4)", 41)]
    public void CalculateMulSum_SimpleCases_PerformsCorrectly(string input, int expected)
    {
        // Arrange
        Day3MullItOver day3MullItOver = new();

        // Act
        var actual = day3MullItOver.CalculateMulSum(input);
    ...
    public void CalculateMulSum_Sample_PerformsCorrectly()
    {
        ...
        // Act
        var actual = day3MullItOver.CalculateMulSum("xmul(2,4)%&mul[3,7]!@^do_not_mul(5,5)+mul(32,64]then(mul(11,8)mul(8,5))");
    ...
    public void CalculateMulSum_Test_PerformsCorrectly()
    {
        ...
        // Act
        var actual = day3MullItOver.CalculateMulSum(_getTestInput());
