...
namespace Codingame.WaterJugRiddle
{
    ...
    public class WaterJugRiddleTests
    {
        ...
        public void GetNumberOfMoves_MultipleSolutions_ReturnsTheShortestOne(int[] capacities, int goal, int expected)
        {
            // Arrange
            WaterJugRiddle waterJugRiddle = new WaterJugRiddle();
        ...
        public void GetNumberOfMoves_ImpossibleCases_ReturnsMinusOne(int[] capacities, int goal)
        {
            // Arrange
            WaterJugRiddle waterJugRiddle = new WaterJugRiddle();
